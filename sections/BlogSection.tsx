    ...
    <div className="bg-[#F5F5F5] dark:bg-[#1B2731]">
      <section ref={sectionRef} id="blog" className="section md:px-10">
        ...
        <div className="text-center mb-8" ref={elementRef}>
          We write blog posts about what we've done and what we're doing{" "}
          <br className="hidden sm:block" aria-hidden="true" /> as a documenting
          practice. Here are some of our recent blog posts.
        </div>
        <div>
          <Swiper
