...
import paraSolutions from "../public/paraSolutions.webp";
...
const AboutSection: React.FC = () => {
  ...
  useEffect(() => {
    aboutSection ? onSectionChange!("Who are we?") : onSectionChange!("");
  }, [aboutSection]);
        ...
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
              ...
              <div className="relative w-72">
                ...
                <div className="profile-picture overflow-hidden md:overflow-visible rounded-md md:shadow-2xl">
                  <Image
                    ...
                    height={1790}
                    priority
                    alt="paraSolutions profile picture"
            ...
            <div
              ...
              ref={eduRef}
            >
              <p className="edu-bg my-4">Lorem ipsum baas</p>
