...
const AppHead: React.FC<Props> = ({
  ...
  let author = "paraSolutions";
  let description =
    "Articles about programming, coding, technologies, software engineering, our personal projects and experiences.";
  let siteName = "paraSolutions's Blog";
  let type = "article";
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/paraSolutions-blog-og.png`;
  let appOgImageAlt = "paraSolutions's Blog";
