...
const socialLinks = [
  {
    id: 1,
    title: "paraSolutions's Github Profile",
    link: "https://github.com/abdfikih",
    svg: (
      <svg
  ...
  {
    id: 2,
    title: "paraSolutions's LinkedIn Profile",
    link: "https://www.linkedin.com/in/abdfikih/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 3,
    title: "Check paraSolutions on Dev.to",
    link: "https://dev.to/paraSolutions",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 4,
    title: "paraSolutions's Profile on Facebook",
    link: "https://www.facebook.com/paraSolutionsonfacebook",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
